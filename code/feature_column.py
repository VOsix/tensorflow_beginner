...
class _IndicatorColumnV1(_DenseColumn,
...
def indicator_columnV1(categorical_column):
  ...
  Returns:
    An `_IndicatorColumn`.
  """
  return _IndicatorColumnV1(categorical_column)
...
indicator = indicator_columnV1(column)
